...
export const PinLockScreen: React.FC = () => {
  const { unlockWithPin, settings } = useSpotOn();
    ...
    <div className="fixed inset-0 z-50 bg-slate-900 text-white flex flex-col items-center justify-center p-6">
      ...
      >
        ...
        <div className="text-center space-y-1">
          <h2 className="text-xl font-bold tracking-tight">SpotOn Locked</h2>
          <p className="text-xs text-slate-400">Enter your 4-digit passcode</p>
        </div>
        ...
        {hasError && (
          <p className="text-xs font-semibold text-rose-400">
            Incorrect passcode. (Default: {settings.pinCode || '1234'})
          </p>
        )}
