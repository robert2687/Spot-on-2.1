...
export const HomeScreen: React.FC = () => {
  const { purchases, settings, openAddModal, setActiveTab } = useSpotOn();
  ...
  return (
    <div className="space-y-4 pb-28">
        ...
        {settings.showBudgetOnHome && (
          <div className="pt-1">
            ...
            <div className="flex justify-between text-[10px] text-slate-400 font-medium">
              <span>Budget: {formatCurrency(budget, settings.currencySymbol)}</span>
      ...
      <motion.div
        ...
        className="space-y-2"
      >
        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">Today</p>
        <div className="bg-slate-50 dark:bg-slate-900/60 border border-slate-100 dark:border-slate-800 rounded-2xl p-4 flex items-center justify-between">
          <div className="flex-1">
            <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Alcohol</p>
          ...
          <div className="flex-1 text-right">
            <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Tobacco</p>
            <p className="font-bold text-base sm:text-lg text-slate-900 dark:text-white mt-0.5">
      ...
      >
        <div className="flex items-center justify-between px-1">
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">30-Day Trend</p>
          {hoveredDay && (
        ...
        <div className="bg-slate-50 dark:bg-slate-900/60 border border-slate-100 dark:border-slate-800 rounded-2xl p-4 space-y-3">
          ...
          <svg className="w-full h-16 overflow-visible" viewBox="0 0 100 30" preserveAspectRatio="none">
            ...
            <path
              d="M0 25 Q 10 20, 20 22 T 40 15 T 60 18 T 80 10 T 100 12"
              fill="none"
              stroke="#60A5FA"
              strokeWidth="2.5"
              strokeLinecap="round"
      ...
      >
        <div className="flex items-center justify-between px-1">
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Recent Logs</p>
          <button
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[11px] text-slate-400 dark:text-slate-500">
                          {formatDateLabel(p.date)} · {formatTime(p.date)}
                          {p.note ? ` · "${p.note}"` : ''}
                        </p>
                      </div>
                    </div>
