        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="font-bold text-slate-900 dark:text-white text-base">Receipt Scanner</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400">Scan or upload to auto-fill purchase</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          {isScanning ? (
            <div className="py-12 flex flex-col items-center justify-center space-y-3">
              ...
              <p className="text-xs text-slate-400">Extracting item name, price, and merchant</p>
            </div>
          ) : (
            <>
              {/* Photo & Upload Area */}
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                          {demo.subcategory} · €{(demo.price * demo.quantity).toFixed(2)}
                        </p>
                      </div>
